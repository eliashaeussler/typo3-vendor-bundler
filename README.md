...
[![CI](https://img.shields.io/github/actions/workflow/status/eliashaeussler/typo3-vendor-bundler/ci.yaml?label=CI&logo=github)](https://github.com/eliashaeussler/typo3-vendor-bundler/actions/workflows/ci.yaml)
