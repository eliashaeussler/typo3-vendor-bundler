...
namespace EliasHaeussler\Typo3VendorBundler;
 ...
 * @codeCoverageIgnore
 */
final readonly class Typo3VendorBundlerPlugin implements Plugin\PluginInterface, Plugin\Capable, Plugin\Capability\CommandProvider
{
