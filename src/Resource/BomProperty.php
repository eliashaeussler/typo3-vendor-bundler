...
{
    case DistReference = 'cdx:composer:package:distReference';
    case PackageType = 'cdx:composer:package:type';
    case SourceReference = 'cdx:composer:package:sourceReference';
}
